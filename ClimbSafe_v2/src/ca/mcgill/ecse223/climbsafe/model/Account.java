...
// line 14 "umpleCode-V3.ump"
// line 111 "umpleCode-V3.ump"
public class Account
{
  ...
  {
    boolean wasSet = false;
    //Must provide nMCP to account
    if (aNMCP == null)
    {
      return wasSet;
    }

    if (nMCP != null && nMCP.numberOfAccounts() <= NMCP.minimumNumberOfAccounts())
    {
      return wasSet;
    }
    ...
    {
      boolean didRemove = existingNMCP.removeAccount(this);
      if (!didRemove)
      {
        nMCP = existingNMCP;
        return wasSet;
