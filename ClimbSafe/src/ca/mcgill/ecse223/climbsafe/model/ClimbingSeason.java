...
// line 52 "umpleCode.ump"
// line 156 "umpleCode.ump"
public class ClimbingSeason
{
  ...
  public ClimbingSeason(Date aStartDate, Date aEndDate, Admin aSeasonDefiner, NMCP aNMCP)
  {
    ...
    if (!didAddNMCP)
    {
      throw new RuntimeException("Unable to create climbingSeason due to nMCP. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }

  public ClimbingSeason(Date aStartDate, Date aEndDate, NMCP aNMCPForSeasonDefiner, Account aAccountForSeasonDefiner, NMCP aNMCP)
  {
    startDate = aStartDate;
    endDate = aEndDate;
    climbingWeeks = new ArrayList<ClimbingWeek>();
  ...
  public boolean setNMCP(NMCP aNMCP)
  {
    ...
    {
      existingNMCP.removeClimbingSeason(this);
    }
    nMCP.addClimbingSeason(this);
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    {
      placeholderNMCP.removeClimbingSeason(this);
    }
  }
