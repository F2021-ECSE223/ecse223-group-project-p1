...
// line 28 "umpleCode.ump"
// line 123 "umpleCode.ump"
public class Admin
{
  ...
  public Admin(String aNameForAccount, String aPasswordForAccount, boolean aIsLoggedForAccount, UserRegistration aUserRegistrationForAccount, NMCP aNMCPForAccount, Date aStartDateForClimbingSeason, Date aEndDateForClimbingSeason, NMCP aNMCPForClimbingSeason)
  {
    name = "admin@nmc.nt";
    password = "admin";
    nMCP = new NMCP(this);
